...
\caption{\hl{Overview} %MDPI: 1. The contents of this figure are not legible. Please replace the image with one of a sufficiently high resolution (min. 1000 pixels width/height, or a resolution of 300 dpi or higher); 2. Please confirm whether an explanation of the colors needs to be added to the figure caption. %Response: [AUTHOR ACTION] Replace this figure with a high-resolution version (>=1000 px or 300 dpi); confirm whether a color explanation is needed in the caption.
...
\caption{\hl{Visual} %MDPI: Commas are only used for numbers with five or more digits. Please remove them from the four-digit numbers in the figure, e.g., “1,200” should be “1200”. %Response: [AUTHOR ACTION] Edit the image to remove commas from four-digit numbers (e.g., 1,200 -> 1200).
%MDPI: References in the form of "[XX]" are not allowed in the image. If necessary, "Author+Year" format can be used as invalid references, and all mentioned references should be cited in the caption. Please add them to the figure caption with reference numbers and place the numbers in square brackets (“[ ]”), e.g., [1], [1–3], or [1,3]. %Response: [AUTHOR ACTION] In the image, change [XX] references to Author+Year and add the bracketed reference numbers to the caption.
representation of the corpus unification process. The dataset was expanded by strategically adding 8985 SATIRE articles via web scraping, resulting in a three-class final distribution: Fake (35.3\%), Real (50.2\%), and Satire (14.5\%). Source: Authors' own elaboration based on study data.}
...
%MDPI: The contents of this figure are not legible. Please replace the image with one of a sufficiently high resolution (min. 1000 pixels width/height, or a resolution of 300 dpi or higher). %Response: [AUTHOR ACTION] Replace this figure with a high-resolution version (>=1000 px or 300 dpi).
