...
\begin{itemize}
    ...
    \item \textbf{A Production-Ready Web Application:} The optimized model was deployed as a Docker-containerized web application capable of real-time URL analysis, demonstrating that the framework extends beyond academic benchmarks to deliver practical tools for public misinformation verification \citep{ali2022fake}.
\end{itemize}
